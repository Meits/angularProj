...
@Component({
  selector: 'app-modal-archive-lead-history',
  templateUrl: './modal-archive-lead-history.component.html',
  styleUrls: ['./modal-archive-lead-history.component.sass']
})
export class ModalArchiveLeadHistoryComponent extends MzBaseModal  implements OnInit {
